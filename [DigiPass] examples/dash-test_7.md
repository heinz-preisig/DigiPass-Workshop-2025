...
example:Root
  ...
  sh:node			example:digipass;
  sh:node         example:Dataset ;
  sh:node		  example:Root-description;
  sh:node		example:PhysicalPropertiesGroupDef.
  
example:PhysicalPropertiesGroupDef
sh:group	example:PhysicalPropertiesGroup;
  sh:property		example:Root-width ;
  sh:property		example:Root-height ;
  sh:property		example:Root-depth ;
  sh:property		example:Root-scale;
  sh:property		example:Root-material .
...
![image-20241120160341751](/home/heinz/Dropbox/workspace/DPP-project/Test-external/image-20241120160341751.png)